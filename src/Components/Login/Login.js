      ...
      <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
        ...
        <DialogContent dividers>
          ...
          <Typography gutterBottom>
            1. This application <strong>Covid Assistance Outlet</strong> is not for commercial usage and was built for creating a community to fight against Coronavirus by sharing resources as a public initiative.
            </Typography>
